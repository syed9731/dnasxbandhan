...
{
    public class ViewsNoteModel
    {
        public ViewNotesModel noteModel { get; set; } = new ViewNotesModel();
        public IEnumerable<ViewApproversModel> approverModel { get; set; } = new List<ViewApproversModel>();
        public IEnumerable<ViewNoteComment> commentModel { get; set; } = new List<ViewNoteComment>();
        public IEnumerable<ViewAttachment> attachmentsModel { get; set; } = new List<ViewAttachment>();
        public IEnumerable<ViewRecomendedApproverModel> recomendedapproverModel { get; set; } = new List<ViewRecomendedApproverModel>();
    }
    ...
    public class ViewApproversModel:CommonApproverModel
    {
    ...
    public class ViewRecomendedApproverModel: CommonRecomendedApproverModel
    {
        //public string ApproverId { get; set; } = string.Empty;
        //public string NoteId { get; set; } = string.Empty;
        //public string UserId { get; set; } = string.Empty;
