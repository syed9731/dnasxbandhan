...
{
    public class WithdrawNoteDetailsModel
    {
        public WithDtlNotesModel noteModel { get; set; } = new WithDtlNotesModel();
        public IEnumerable<WithDtlApproversModel> approverModel { get; set; } = new List<WithDtlApproversModel>();
        public IEnumerable<WithDtlNoteComment> commentModel { get; set; } = new List<WithDtlNoteComment>();
        public IEnumerable<WithDtlAttachment> attachmentsModel { get; set; } = new List<WithDtlAttachment>();
        public IEnumerable<WithDtlRecomendedApproverModel> recomendedapproverModel { get; set; } = new List<WithDtlRecomendedApproverModel>();
    }
    public class WithDtlNotesModel
    {
    ...
    public class WithDtlApproversModel:CommonApproverModel
    {
    ...
    public class WithDtlNoteComment
    {
    ...
    public class WithDtlAttachment
    {
    ...
    public class WithDtlRecomendedApproverModel:CommonRecomendedApproverModel
    {
